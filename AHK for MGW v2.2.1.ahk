...
if hello := 1
{
    ShowGameText("~g~MONSER DEATHMATCH", 5000, 4)
}
toggleAntiBikeFall()
...
{
    SendMessage, 0x50,, 0x4190419,, A
SendInput, {f6}/pm  Желаю Вам новогоднего настроения на Monser DeathMatch :3{LEFT 57}
    return
}
Button13:
{
...
if (chatInput="/gg")
{
    ...
    if rand=1
    {
        ...
        sleep 3000
        SendChat("/msg Администрация Monser DeathMatch желает Вам новогоднего настроения :3")
    }
    if rand=2
    {
